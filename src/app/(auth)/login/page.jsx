      ...
      <div className="p-20 col-span-1 flex flex-col">
        <Tabs defaultValue="account" className="w-[400px]">
          <TabsList className="grid w-full grid-cols-2 mb-6">
            <TabsTrigger value="account" className="text-white">Socials</TabsTrigger>
          ...
          <TabsContent className="border-none outline-none" value="account">
            <Card className="bg-transparent border-none text-white">
              <CardHeader>
                <CardTitle ><span className="text-4xl">Sign in</span> </CardTitle>
                <CardDescription>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-1">
                  <Input type="email" className="rounded-full p" placeholder="Provide email" />
                </div>
                <div className="space-y-1">
                  <Input className="rounded-full h-12" type="password" placeholder="Password" />
                </div>
              </CardContent>
              <CardFooter className="flex flex-col space-y-2">
                <Button className="w-full bg-pink-600 text-white rounded-full">Create Account</Button>
                <Button variant="outline" className="w-full text-white rounded-full">
                  Sign up with Google
                </Button>
              </CardFooter>
              <div className="flex justify-center mt-4 text-xs">
                <p className="text-white">Already have an account?</p>
                <a href="" className="text-pink-600 ml-1">Sign In</a>
              </div>
            </Card>
          </TabsContent>
